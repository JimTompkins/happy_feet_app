...
class OggPiano {
  ...
  void init() {
    ...
    rootBundle.load('assets/sounds/bass_drum_fade.ogg').then((ogg0) {
      fop.load(src: ogg0, name: 'bass_drum_fade.ogg', index: 0, forceLoad: true);
    ...
    rootBundle.load('assets/sounds/Bass74MapleJazzA1_5sTrimEnvelope2dB.ogg').then((ogg6) {
      fop.load(src: ogg6, name: 'Bass74MapleJazzA1_5sTrimEnvelope2dB.ogg', index: 6, forceLoad: true);
...
//      fop.load(src: ogg6, name: 'Yamaha-TG55-Jazz-Man-C2.ogg.ogg', index: 6, forceLoad: true);
    ...
    rootBundle.load('assets/sounds/woodblock1.ogg').then((ogg10) {
      fop.load(src: ogg10, name: 'woodblock1.ogg', index: 10, forceLoad: true);
